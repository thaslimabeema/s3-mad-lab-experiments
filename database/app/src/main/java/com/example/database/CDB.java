...
public class CDB extends SQLiteOpenHelper {
    ...
    public void addDept(String fn,String ln,String dob,String pl,String ph){
        try{
    ...
    public String[] getOneDepartment(String fname)
    {
        ...
        try{
            ...
            Cursor cursor=db.query("TbDept",new String[]{"fname","lname","dob","place","phone"},"fname"+"=?",new String[] {String.valueOf(fname)},null,null,null,null);
    ...
    public int deleteDept(String fname){
        SQLiteDatabase db=this.getWritableDatabase();
